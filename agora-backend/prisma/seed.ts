...
async function main() {
  ...
  await prisma.userRole.upsert({
    ...
    update: { role_id: roleByName.get('SUPER_ADMIN')! },
    create: { user_id: superAdmin.id, role_id: roleByName.get('SUPER_ADMIN')! },
  })
  ...
  await prisma.userRole.upsert({
    ...
    update: { role_id: roleByName.get('ADMIN')! },
    create: { user_id: admin.id, role_id: roleByName.get('ADMIN')! },
  })
  ...
  await prisma.userRole.upsert({
    ...
    update: { role_id: roleByName.get('MANAGER')! },
    create: { user_id: manager.id, role_id: roleByName.get('MANAGER')! },
  })
  ...
  await prisma.userRole.upsert({
    ...
    update: { role_id: roleByName.get('CASHIER')! },
    create: { user_id: cashier.id, role_id: roleByName.get('CASHIER')! },
  })
  ...
  for (const p of products) {
    ...
    await prisma.stockLevel.upsert({
      ...
      update: { quantity: qty, low_stock_threshold: threshold, high_stock_threshold: threshold * 5 },
      create: { product_id: product.id, quantity: qty, low_stock_threshold: threshold, high_stock_threshold: threshold * 5 },
    })
  }
